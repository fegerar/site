...
const components = {
  ...
  a: ({ href, children, ...props }: AnchorProps) => {
    const className = 'text-gray-900 hover:text-blue-500 dark:text-gray-400 dark:hover:text-gray-300 dark:underline dark:underline-offset-2 dark:decoration-gray-800';
    if (href?.startsWith('/')) {
      return (
  ...
  blockquote: (props: BlockquoteProps) => (
    <blockquote
      className="ml-[0.075em] border-l-3 border-gray-300 dark:border-zinc-600 pl-4 text-gray-700 dark:text-zinc-300"
      {...props}
    />
  ),
};
